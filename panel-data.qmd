...
seg_customer <- tbl(pg, sql("SELECT * FROM comp_segments_hist_daily.seg_customer"))
names_seg <- tbl(pg, sql("SELECT * FROM comp_segments_hist_daily.names_seg"))
...
What happens if you omit the year fixed effects from both sets of regressions?
What does this tell you about what drives the regression results in this setting?
6. What patterns do you observe in the coefficients reported in the table titled "Effect of IDD adoption by year"? 
...
8. How helpful do you find the plot of the coefficients by year?
