...
The results from models show in the text are presented in @tbl-admissions.

```{r}
#| message: false
#| echo: false
#| label: tbl-admissions
#| tbl-cap: "Student admissions: Regression results"
modelsummary(fms,
             estimate = "{estimate}",
             statistic = NULL,
...
2. Do any of the three regressions reported in @tbl-admissions provide good estimates of $\beta$?
3. Consider regression (3) in @tbl-admissions. 
