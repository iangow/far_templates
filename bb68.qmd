...
temp <- read_lines(t)
vw_start <- str_which(temp, "^\\s+Average Value Weight Returns -- Monthly")
vw_end <-  str_which(temp, "^\\s+Average Equal Weighted Returns -- Monthly") - 4

ew_start <- str_which(temp, "^\\s+Average Equal Weighted Returns -- Monthly")
