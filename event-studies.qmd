...
apple_reg_data <-
  ...
  select(permno, date, ret, mkt_ret, vol, is_event)
```
...
What do you observe in the raw returns for Canada, Europe, and Asia for the four events that are the focus of Panel B of Table 1 of @Zhang:2007tv?
Does this raise concerns about @Zhang:2007tv's results?

2. Describe the process for constructing the test statistics reported in Panel D of Table 1.
...
5. Interpret the results of Table 5, Panel B.
